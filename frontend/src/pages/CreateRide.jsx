...
function CreateRide({ currentUserId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate return time is after departure if round trip
  ...
  // Get current datetime for min value on datetime inputs
  ...
  return (
    <div style={{ maxWidth: '400px', margin: '0 auto' }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Return time — only shown if round trip is checked */}
        {isRoundTrip && (
          <div style={{ marginBottom: '12px' }}>
